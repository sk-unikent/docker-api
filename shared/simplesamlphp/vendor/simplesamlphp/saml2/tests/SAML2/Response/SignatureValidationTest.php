...
class SAML2_Response_SignatureValidationTest extends PHPUnit_Framework_TestCase
{
     ...
     * @var string
     */
    private $currentDestination = 'http://api.bridge.feide.no/simplesaml/saml2/sp/AssertionConsumerService.php';
    ...
    public function setUp()
    {
        ...
        $this->serviceProviderConfiguration
            = new SAML2_Configuration_ServiceProvider(array('entityId' => 'urn:mace:feide.no:services:no.feide.api'));
    }
